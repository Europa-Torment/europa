# Europa Torment lore basics

If you're interested in creating narrative game content, you need to follow these basic lore principles. Consider the time frame of events.

![Timeline](/docs/timeline.png)

## Key organisations

* **Europa Terraforming Center (ETC)** - the power core of Europa. A small artificial sun. A chain of thermonuclear reactors that generate energy through hydrogen fusion and form an atmosphere. It was completely destroyed in the disaster.
...
* **Li Tian**. Nuclear physicist. One of the first colonists, co-author of the first mass-produced thermonuclear reactor. Director of the Europa Terraforming Center.
